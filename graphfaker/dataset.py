...
class OverpassFetcher:
    @staticmethod
    def fetch_transportation_network(bbox="-0.489,51.28,0.236,51.686"):  # London Bounding Box
        ...
        if response.status_code == 200:
            ...
            print("Overpass Query Failed!", response.status_code)
            return None
...
if __name__ == "__main__":
    ...
    print("People:", G_ceos.nodes(data=True))
    print("Places:", G_places.nodes(data=True))
    print("Organizations:", G_orgs.nodes(data=True))
